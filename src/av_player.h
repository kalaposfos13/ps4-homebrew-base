...
using AvPlayerAllocate = void* (*)(void* p, u32 align, u32 size);
using AvPlayerDeallocate = void (*)(void* p, void* mem);
using AvPlayerAllocateTexture = void* (*)(void* p, u32 align, u32 size);
using AvPlayerDeallocateTexture = void (*)(void* p, void* mem);
...
using AvPlayerOpenFile = s32 (*)(void* p, const char* name);
using AvPlayerCloseFile = s32 (*)(void* p);
using AvPlayerReadOffsetFile = s32 (*)(void* p, u8* buf, u64 pos, u32 len);
using AvPlayerSizeFile = u64 (*)(void* p);
...
using AvPlayerEventCallback = void (*)(void* p, AvPlayerEvents event, s32 src_id,
                                                    void* data);
...
using AvPlayerLogCallback = int (*)(void* p, const char* format, va_list args);


s32 sceAvPlayerAddSource(AvPlayerHandle handle, const char* filename);
s32 sceAvPlayerAddSourceEx(AvPlayerHandle handle, AvPlayerUriType uri_type,
                                        AvPlayerSourceDetails* source_details);

int sceAvPlayerChangeStream();
s32 sceAvPlayerClose(AvPlayerHandle handle);
u64 sceAvPlayerCurrentTime(AvPlayerHandle handle);
s32 sceAvPlayerDisableStream(AvPlayerHandle handle, u32 stream_id);
s32 sceAvPlayerEnableStream(AvPlayerHandle handle, u32 stream_id);
bool sceAvPlayerGetAudioData(AvPlayerHandle handle, AvPlayerFrameInfo* p_info);
s32 sceAvPlayerGetStreamInfo(AvPlayerHandle handle, u32 stream_id,
                                          AvPlayerStreamInfo* p_info);
bool sceAvPlayerGetVideoData(AvPlayerHandle handle, AvPlayerFrameInfo* video_info);
bool sceAvPlayerGetVideoDataEx(AvPlayerHandle handle,
                                            AvPlayerFrameInfoEx* video_info);
AvPlayerHandle sceAvPlayerInit(AvPlayerInitData* data);
s32 sceAvPlayerInitEx(const AvPlayerInitDataEx* p_data, AvPlayerHandle* p_player);
bool sceAvPlayerIsActive(AvPlayerHandle handle);
s32 sceAvPlayerJumpToTime(AvPlayerHandle handle, uint64_t time);
s32 sceAvPlayerPause(AvPlayerHandle handle);
s32 sceAvPlayerPostInit(AvPlayerHandle handle, AvPlayerPostInitData* data);
s32 sceAvPlayerPrintf(const char* format, ...);
s32 sceAvPlayerResume(AvPlayerHandle handle);
s32 sceAvPlayerSetAvSyncMode(AvPlayerHandle handle, AvPlayerAvSyncMode sync_mode);
s32 sceAvPlayerSetLogCallback(AvPlayerLogCallback log_cb, void* user_data);
s32 sceAvPlayerSetLooping(AvPlayerHandle handle, bool loop_flag);
s32 sceAvPlayerSetTrickSpeed(AvPlayerHandle handle, s32 trick_speed);
s32 sceAvPlayerStart(AvPlayerHandle handle);
s32 sceAvPlayerStop(AvPlayerHandle handle);
s32 sceAvPlayerStreamCount(AvPlayerHandle handle);
s32 sceAvPlayerVprintf(const char* format, va_list args);
}